...
def main(name):
    ...
    plt.plot(minimun_prior, color="tomato", lw=0.5, linestyle="dashed")
    plt.plot(
        prior_mean["snd"] + prior_sd["snd"],
        color="tomato",
        lw=0.5,
    ...
    plt.plot(prior_mean["snd"], color="red", lw=1, label="Open-loop")

    plt.fill_between(
        ids, minimun, updated["snd"] + sd["snd"], color="mediumaquamarine"
    )
    plt.plot(minimun, color="seagreen", lw=0.5, linestyle="dashed")
    plt.plot(
        updated["snd"] + sd["snd"],
        color="seagreen",
        lw=0.5,
    ...
    plt.plot(updated["snd"], color="darkgreen", lw=1, label="Updated")
    ...
    try:
        ...
        plt.plot(minimun_mcmc, color="dodgerblue", lw=0.5, linestyle="dashed")
        plt.plot(
            updatedmcmc["snd"], color="dodgerblue", lw=1, label="Updated-MCMC"
        )
    except Exception:
        pass

    plt.plot(ol["snd"], color="black", lw=0.8, label="Reference run")
    plt.scatter(
        x,
        y,
