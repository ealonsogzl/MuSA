> [!CAUTION]
> The current version under development has a minor but annoying problem that will be resolved shortly (under threat of revealing the identity of the person responsible :smiling_imp:). We recommend using the code from the last tag V2.3.
