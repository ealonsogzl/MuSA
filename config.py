...
This config file is a general one and will be adjusted according to the specific experiment.
Currently the config file is only adjusted per tile!
...
dt = 3600*3  # timestep in seconds
# -----------------------------------
# Directories
# -----------------------------------

nc_obs_path = "./DATA/Obs/"
nc_forcing_path = "./tmp_test/FORCINGS/" #'./test/y034x201/FORCINGS/'
...
tmp_path = "/scratch/gent/vo/000/gvo00090/vsc44965/TMP_MUSA"
...
# implementation from "point_scale", "distributed", "Spatial_propagation" or "open_loop"
...
date_ini = "2015-09-01 00:00"
date_end = "2024-08-31 21:00"
...
# -----------------------------------
# Run the simulation in memory to avoid I/O (uses a lot of memory for now)
# Only for MPI or multiprocessing, and no restart
spatial_in_mem = False
...
forcing_var_names = {"SW_var_name": "SWd",
                     "LW_var_name": "LWd",
                     "Precip_var_name": "P",
                     "Press_var_name": "Ps",
                     "RH_var_name": "RH",
...
#TODO: let this adapt automatically
