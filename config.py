...
# If restart_run is enabled, the outputs will not be overwritten (with spatial
# propagation, this is ignored)
restart_run = False
# If restart_forcing, the forcing will be read from the intermediate files
