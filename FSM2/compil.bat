...
echo #define DENSTY 2   /* snow density                : 0, 1, 2         */
echo #define EXCHNG 1   /* turbulent exchange          : 0, 1            */
echo #define HYDROL 2   /* snow hydraulics             : 0, 1, 2         */
echo #define SNFRAC 2   /* snow cover fraction         : 1, 2            */
echo /* Driving data options                           : Possible values */
echo #define DRIV1D 1   /* 1D driving data format      : 1, 2            */
